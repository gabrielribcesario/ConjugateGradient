...
// Compile with:
// icx -shared -o ConjugateGradient.so conjugategradient.c -fPIC -O2 -mavx512f

double* jacobi(double* A, const size_t n) {
    return M;
}
double* ssor(double* A, const size_t n) {
